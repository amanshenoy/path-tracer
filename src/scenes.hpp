core::Scene GetScene(double& aspect_ratio, glm::vec3& lookfrom, glm::vec3& lookat, int& height, int& width, double& fovy, std::string name, core::Scene& lights, float& aperture, float& focal_distance){
    core::Scene world; 
